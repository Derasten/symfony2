    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["blog"]) {
            ...
            <header>
                <h2><a href=\"";
            // line 9
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("PruebaInicialBundle_blog_show", array("id" => $this->getAttribute((isset($context["blog"]) ? $context["blog"] : $this->getContext($context, "blog")), "id"))), "html", null, true);
            echo "\">";
